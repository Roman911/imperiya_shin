...
export const trackProductView = (data: Product | undefined, section: string) => {
	if(!data) return;
...
export const trackAddToCart = (data: Product | Products | undefined, section: string, quantity: number) => {
	if(!data) return;
...
export const trackBeginCheckout = (data: ProductsProps | undefined, cartItem: {id: number, quantity: number, section: string}[]) => {
	if(!data) return;
...
export const trackPurchase = (data: ProductsProps | undefined, cartItem: {id: number, quantity: number, section: string}[], orderId: number) => {
	if(!data) return;
